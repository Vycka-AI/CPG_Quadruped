...
from CPG_IK import CPG_Network_Hopf_IK

class UnitreeEnv(gym.Env):
    def __init__(self, model_path, render_mode=None, frame_skip=4, ik = False):
        super().__init__()
        ...
        if ik == False:
            ...
            self.cpg_network = CPG_Network_Hopf_IK(self.dt, half_circle=True)
        # Observation Scales
        self.obs_scales = {
