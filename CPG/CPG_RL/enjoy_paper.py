...
if __name__ == "__main__":
    ...
    #Working without command mixup
    model_name = "./models/Backup/Train_Paper_Gait/rl_model_v2__2500000_steps.zip"
    vec_norm_name = "./models/Backup/Train_Paper_Gait/rl_model_v2__2500000_steps_vecnormalize.pkl"

    #model_name = "./models/Backup/Train_Paper_Gait_Directions/rl_model_v2__10900000_steps.zip"
    #vec_norm_name = "./models/Backup/Train_Paper_Gait_Directions/rl_model_v2__10900000_steps_vecnormalize.pkl"

    #512 model
    #Train_Paper_Gait_Directions_512
    #model_name = "./models/Backup/Train_Paper/rl_model_v2__5500000_steps.zip"
    #vec_norm_name = "./models/Backup/Train_Paper/rl_model_v2__5500000_steps_vecnormalize.pkl"
    ...
    env = DummyVecEnv([lambda: UnitreeEnv(model_path=xml_path, frame_skip=10, sample_mixup=True)])
